...
export default function PlayerDetail()
{
    ...
    return (
        <div className="bg-background">
            ...
            <button onClick={() => setStatus("matches")} className={`text-secondary hover:bg-secondary hover:text-text font-itim py-1 cursor-pointer ${status === "heroes"? "bg-background text-text" : ""}`}>Matches</button>
            </div>
