  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="w-[90%] mx-auto bg-background pt-9">
        ...
        <div className="flex justify-between items-center mt-9 max-w-150 mx-auto">
      ...
      {/* ================= Status Buttons ================= */}
      <div className="mt-9 w-[90%] max-w-250 mx-auto flex border-2 border-text rounded-md">
              ...
              <thead>
                <tr className="bg-[#3D3D43]">
                  ...
                  {Array.from({ length: 8 }).map((_, i) => (
                    <th key={i} className="py-1 min-w-22.5">
                ...
                {Array.from({ length: 5 }).map((_, row) => (
                  <tr key={row}>
                    ...
                    {Array.from({ length: 8 }).map((_, col) => (
                      <td key={col} className="py-1 min-w-22.5">
